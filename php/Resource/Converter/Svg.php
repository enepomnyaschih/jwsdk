...
class JWSDK_Resource_Converter_Svg extends JWSDK_Resource_Converter_Internal
{
		...
		$params)   // Object
	{
		...
		return "$varName = new DOMParser().parseFromString('$contents', 'text/html').body.firstChild;\n";
	}
