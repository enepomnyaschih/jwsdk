...
include_once $jwsdkDir . 'php/Exception/CompressorError.php';
...
include_once $jwsdkDir . 'php/Exception/JsxError.php';
include_once $jwsdkDir . 'php/Exception/LessError.php';
...
include_once $jwsdkDir . 'php/Exception/StylusError.php';
...
JWSDK_Log::logTo('build.log', 'Building frontend with jWidget SDK 0.6.2...');
